...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-blue-600 to-primary items-center justify-center p-12 relative overflow-hidden">
        ...
        >
          <div className="mb-8">
            ...
            <p className="text-white/80 text-lg max-w-sm mx-auto">
              Create your account and start your professional journey with industry-leading programs.
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 max-w-sm mx-auto">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center">
              ...
              <div className="text-xs text-white/70">Teachers</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center">
